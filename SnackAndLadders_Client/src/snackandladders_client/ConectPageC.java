...
public class ConectPageC extends JFrame implements ActionListener {
 ...
 ///sockets...
  ...
  ServerSocket ss;
    ...
    public ConectPageC(String s1) {
        
        super("Snacks and Ladders_Host");
        new StartPageC().setVisible(false);
        setVisible(true);
...
//          dout.writeUTF(s1);
    ...
    public void actionPerformed(ActionEvent e) {
               if(e.getSource()==b)
               {
                   new StartPageC().setVisible(true);
                   setVisible(false);
               }
               if(e.getSource()==b1)
               {
...
//                        userInput=in.readLine();
             ...
             // new Play_hostC(s,port1,userInput).setVisible(true);
