 ...
 * @author HP
 */
class gameC extends JFrame implements ActionListener {
 ...
 //JButton b5=new JButton(new ImageIcon("Image\\person1.png"));
  ...
  ///JTextField....
  JTextField tf= new JTextField("First player name");
  JTextField tf1= new JTextField("Second player name");
 /// JPanel.....
 ...
 // JPanel p2=new JPanel((LayoutManager) new ImageIcon("Image\\bord.jpg"));
    ...
    int x1=2,y1=530,x2=177,y2=530,v=0,v1=0,start1=0,start2=0,a1=5,a2=546,c1=45,c2=546,ra,ra1;
